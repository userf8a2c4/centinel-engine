...
"""Resolución centralizada de rutas para snapshots y hashes.

Centralized path resolution for snapshots and hashes.

Todas las funciones que necesiten construir rutas de snapshot o hash
deben usar este módulo como fuente única de verdad.

All functions that need to build snapshot or hash paths must use this
