...
======================== ESPAÑOL ========================
Archivo: `src/centinel/utils/logging_config.py`.
...
======================== ENGLISH ========================
File: `src/centinel/utils/logging_config.py`.
...
class SensitiveLogFilter(logging.Filter):
    ...
    def filter(self, record: logging.LogRecord) -> bool:
        """Español: Función filter del módulo src/centinel/utils/logging_config.py.
