...
======================== ESPAÑOL ========================
Archivo: `src/centinel/core/rules/correlation_participation_vote_rule.py`.
...
======================== ENGLISH ========================
File: `src/centinel/core/rules/correlation_participation_vote_rule.py`.
...
# Correlation Participation Vote Rule Module
# AUTO-DOC-INDEX
#
# ES: Índice rápido
