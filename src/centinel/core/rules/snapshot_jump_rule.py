...
======================== ESPAÑOL ========================
Archivo: `src/centinel/core/rules/snapshot_jump_rule.py`.
...
======================== ENGLISH ========================
File: `src/centinel/core/rules/snapshot_jump_rule.py`.
...
from centinel.core.rules.common import extract_total_votes, parse_timestamp
