...
======================== ESPAÑOL ========================
Archivo: `src/centinel/core/rules/participation_anomaly_rule.py`.
Este módulo forma parte de Centinel Engine y está documentado para facilitar
la navegación, mantenimiento y auditoría técnica.

Componentes detectados:
  - _calculate_scrutiny_percentage
  - apply
...
======================== ENGLISH ========================
File: `src/centinel/core/rules/participation_anomaly_rule.py`.
...
# Participation Anomaly Rule Module
# AUTO-DOC-INDEX
#
# ES: Índice rápido
