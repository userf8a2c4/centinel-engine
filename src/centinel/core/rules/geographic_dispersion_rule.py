...
======================== ESPAÑOL ========================
Archivo: `src/centinel/core/rules/geographic_dispersion_rule.py`.
Este módulo forma parte de Centinel Engine y está documentado para facilitar
la navegación, mantenimiento y auditoría técnica.

Componentes detectados:
  - _extract_department_candidate_shares
  - apply
...
======================== ENGLISH ========================
File: `src/centinel/core/rules/geographic_dispersion_rule.py`.
...
# Geographic Dispersion Rule Module
# AUTO-DOC-INDEX
#
# ES: Índice rápido
