# Code of Conduct — Centinel Engine
...
Given the sensitive electoral context of this project, contributors additionally agree to:

- **Candidate neutrality**: All code, tests, documentation, and discussion must remain
  100% candidate-agnostic. No candidate names, party names, or political positions may
  appear in code, test fixtures, or documentation.
- **Data integrity over narrative**: Contributions must focus on data integrity verification,
  not on supporting or opposing any political outcome.
- **Responsible disclosure**: Security vulnerabilities in the monitoring system must be
  reported privately to maintainers before public disclosure. See `SECURITY.md`.
- **No replay of protected datasets**: Electoral datasets shared for validation purposes
  must not be integrated into the public system without explicit written permission.
...
contacting the project team via the repository's issue tracker (for non-sensitive matters)
or privately via the security contact described in `SECURITY.md`. All complaints will be
