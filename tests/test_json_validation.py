...
======================== ESPAÑOL ========================
Archivo: `tests/test_json_validation.py`.
Este módulo forma parte de Centinel Engine y está documentado para facilitar
la navegación, mantenimiento y auditoría técnica.

Componentes detectados:
  - _create_test_db
  - TestFetchLatestSnapshotCorruptedJson
  - TestFetchSnapshotByHashCorruptedJson
  - TestLoadAlertsCorruptedJson
  - TestStorageCanonicalJsonValidation
...
======================== ENGLISH ========================
File: `tests/test_json_validation.py`.
