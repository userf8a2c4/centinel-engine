...
======================== ESPAÑOL ========================
Archivo: `tests/resilience/test_proxies.py`.
...
Componentes detectados:
  - _DummyResponse
  - _DummyClient
  - test_proxy_validation_rejects_403_and_errors
  - test_proxy_rotator_round_robin_and_fallback_to_direct
  - test_proxy_rotator_refreshes_pool_when_empty
...
======================== ENGLISH ========================
File: `tests/resilience/test_proxies.py`.
